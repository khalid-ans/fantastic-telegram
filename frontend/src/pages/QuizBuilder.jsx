    ...
    return (
        <div className="space-y-8 animate-in pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {mode === 'auto' ? (
                        <div className="bg-white border border-gray-100 card-shadow rounded-2xl p-6 space-y-4">
                            ...
                            <textarea
                                ...
                                rows={15}
                                className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:border-primary-500 outline-none font-mono text-sm resize-none text-gray-800 placeholder:text-gray-400"
                            />
                        ...
                        <div className="space-y-6">
                            ...
                            {quizzes.map((quiz, idx) => (
                                <div key={idx} className="bg-white border border-gray-100 card-shadow rounded-2xl p-6 relative group">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <input
                                                ...
                                                className="flex-1 bg-transparent border-b border-gray-200 focus:border-primary-500 focus:outline-none py-1 font-bold text-gray-900"
                                        ...
                                        <div className="pl-8 space-y-2">
                                            {quiz.options.map((opt, oIdx) => (
                                                <div key={oIdx} className="flex items-center gap-2 group/opt">
                                                    ...
                                                    <input
                                                        ...
                                                        className="flex-1 bg-transparent border-b border-gray-100 focus:border-primary-500 focus:outline-none text-sm py-1 text-gray-700"
                                                    />
                                                    {quiz.options.length > 2 && (
                                                        <button
                                                            onClick={() => removeOption(idx, oIdx)}
                                                            className="text-gray-400 hover:text-red-500 opacity-0 group-hover/opt:opacity-100"
                                                        >
                                            ...
                                            {quiz.options.length < 10 && (
                                                <button
                                                    ...
                                                    className="text-xs text-primary-600 hover:text-primary-700 flex items-center gap-1 mt-2 font-bold"
                                                >
                                        ...
                                        <div className="pl-8">
                                            <input
                                                ...
                                                className="w-full bg-gray-50 text-xs px-3 py-2 rounded-lg text-blue-600 font-medium focus:outline-none focus:bg-white focus:ring-1 focus:ring-blue-200 border border-transparent focus:border-blue-100"
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <button onClick={handleManualAdd} className="w-full py-4 rounded-xl border-2 border-dashed border-gray-300 text-gray-400 hover:border-primary-400 hover:text-primary-500 flex items-center justify-center gap-2 font-bold transition-all bg-gray-50 hover:bg-primary-50">
                ...
                <div className="space-y-6">
                    <div className="bg-white border border-gray-100 card-shadow rounded-2xl p-6 space-y-4">
                        <h2 className="font-bold text-gray-900 leading-none">Settings</h2>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
                            />
                        </div>

                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1">Schedule Time</label>
                            <input
                                type="datetime-local"
                                ...
                                className="w-full px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-100"
                            />
                            {scheduledTime && (
                    ...
                    <div className="bg-white border border-gray-100 card-shadow rounded-2xl p-6">
                        <h2 className="font-bold mb-4 text-gray-900 leading-none">Select Folders</h2>
                        <div className="space-y-2 max-h-48 overflow-y-auto">
                            {folders.map(f => (
                                <label key={f._id} className="flex items-center gap-2 cursor-pointer p-2 hover:bg-gray-50 rounded-lg transition-colors">
                                    <input
                                        type="checkbox"
